...
use slate_kv_core::gc::{SegState, SegTable};
...
struct MockSealer;
impl slate_kv_core::log::Sealer for MockSealer {
    ...
    fn verify_marker(&self, _cm: &[u8; CM_LEN]) -> Result<slate_kv_core::log::CmFields, Error> {
